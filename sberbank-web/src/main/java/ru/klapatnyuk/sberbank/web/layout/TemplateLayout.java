...
public class TemplateLayout extends VerticalLayout {
    ...
    private FieldLayout newRow(Field field) {
        ...
        type.setItemCaption(Field.Type.LINE, SberbankUI.I18N.getString(FormKey.FIELD_TYPE_LINE));
        type.addItem(Field.Type.AREA);
        type.setItemCaption(Field.Type.AREA, SberbankUI.I18N.getString(FormKey.FIELD_TYPE_AREA));
        type.addItem(Field.Type.CHECKBOX);
        type.setItemCaption(Field.Type.CHECKBOX, SberbankUI.I18N.getString(FormKey.FIELD_TYPE_CHECKBOX));
        ...
        remove.setDescription(SberbankUI.I18N.getString(FormKey.FIELD_REMOVE));
