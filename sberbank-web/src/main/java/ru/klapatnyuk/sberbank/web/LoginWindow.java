...
public class LoginWindow extends AbstractCenteredWindow {
    ...
    public LoginWindow(ResourceBundle bundle, String title) {
        super(bundle, title);
    }
    ...
    private void initLoginTextField() {
        ...
        final Validator validator =
                new StringLengthValidator(SberbankUI.I18N.getString(SberbankKey.Notification.LOGIN_LOGIN_INVALID,
                        SberbankUI.I18N.getString(SberbankKey.Form.LOGIN_LOGIN_LABEL)), 1,
    ...
    private void initPasswordField() {
        ...
        final Validator validator =
                new StringLengthValidator(SberbankUI.I18N.getString(SberbankKey.Notification.LOGIN_PASSWORD_INVALID,
                        SberbankUI.I18N.getString(SberbankKey.Form.LOGIN_PASSWORD_LABEL)), 1,
                        ValidatePattern.PASSWORD_LENGTH, false);
        passwordField.addValidator(validator);
    }

    private void initSubmitButton() {
        submitButton = new Button(SberbankUI.I18N.getString(SberbankKey.Form.LOGIN_BUTTON));
    ...
    private HorizontalLayout newLoginRow() {
        return newFormRow(SberbankUI.I18N.getString(SberbankKey.Form.LOGIN_LOGIN_LABEL), loginTextField);
    }

    private HorizontalLayout newPasswordRow() {
        return newFormRow(SberbankUI.I18N.getString(SberbankKey.Form.LOGIN_PASSWORD_LABEL), passwordField);
    }
